<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeFile="adminbookinventory.aspx.cs" Inherits="WebApplication3.adminbookinventory" %>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TESTDB10ConnectionString2 %>" SelectCommand="SELECT [book_id], [book_name], [author_name], [publisher_name], [actual_stock], [current_stock] FROM [book_master_tbl]"></asp:SqlDataSource>
                     <div class="col">
